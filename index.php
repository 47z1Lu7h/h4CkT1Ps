      ...
      <ul class="nospace group center">
        <li class="one_third first">
          <article><i class="btmspace-30 fa fa-3x fa-low-vision"></i>
            ...
            <footer><a class="btn" href="/h4CkT1Ps/views/pages/tools.php">Read More &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><i class="btmspace-30 fa fa-3x fa-paw"></i>
            ...
            <footer><a class="btn" href="/h4CkT1Ps/views/pages/vulns.php">Read More &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><i class="btmspace-30 fa fa-3x fa-cube"></i>
            ...
            <footer><a class="btn" href="/h4CkT1Ps/views/pages/pentest.php">Read More &raquo;</a></footer>
          </article>
        </li>
      </ul>
      <!-- ################################################################################################ -->
