  ...
  <div class="wrapper row2 bgded overlay" style="background-image:url('../assets/images/demo/backgrounds/02.png');">
    <div id="breadcrumb" class="hoc clear">
      ...
      <ul>
        ...
        <li><a href="/h4CkT1Ps/views/pages/medio.php">Media</a></li>
      </ul>
      <!-- ################################################################################################ -->
    </div>
  </div>
  ...
  <div class="wrapper row3">
    <main class="hoc container clear">
      ...
      <div class="content three_quarter">
        <!-- ################################################################################################ -->
        <h1><strong> Nivel Medio </strong> </h1>
        <div>  <p><h2>Curso de hacking Web</h2></p>
          <img class="imgr borderedbox inspace-5" src="" alt="test">
          <p> </p>
          <p>alalala<a href="/h4CkT1Ps/views/pages/webAttacks.php"> Aquí</a>, muchas gracias :)</p>
          </div> 
        <!-- ################################################################################################ -->
      </div>
</main>
