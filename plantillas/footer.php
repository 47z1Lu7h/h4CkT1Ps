  ...
  <div class="wrapper row4">
    <footer id="footer" class="hoc clear">
      ...
      <div class="center btmspace-50">
        <h2 class="heading">H4Ck-T1p5</h2>
        <ul class="faico clear">
          <li><a class="faicon-facebook" href="#"><i class="fa fa-facebook"></i></a></li>
          <li><a class="faicon-twitter" href="#"><i class="fa fa-twitter"></i></a></li>
          <li><a class="faicon-reddit-alien" href="#"><i class="fa fa-star"></i></a></li>
          <li><a class="faicon-linkedin" href="#"><i class="fa fa-linkedin"></i></a></li>
          <li><a class="faicon-google-plus" href="#"><i class="fa fa-times"></i></a></li>
      ...
      <div class="group btmspace-50">
        <div class="one_third first">
          <h6 class="heading">Donde nos encntramos</h6>
          <ul class="nospace btmspace-30 linklist contact">
            <li><i class="fa fa-map-marker"></i>
              <address>
                Avenida de Galicia, &amp; 101, 36216 Vigo, Pontevedra
              </address>
            </li>
            <li><i class="fa fa-phone"></i> +0034 886 12 04 64</li>
            <li><i class="fa fa-fax"></i> +0044 888 88 88 88 </li>
            <li><i class="fa fa-envelope-o"></i>info@h4Cktips.com</li>
          </ul>
        </div>
        <div class="one_third">
          <h6 class="heading">Ultimas nocticias interesantes</h6>
          <ul class="nospace linklist">
            <li>
              <article>
                <h2 class="nospace font-x1"><a href="#">Una nocticia interesante</a></h2>
            ...
            <li>
              <article>
                <h2 class="nospace font-x1"><a href="#">Otra nocticia interesante</a></h2>
        ...
        <div class="one_third">
          <h6 class="heading">Subscribete a nuestro Newsletter</h6>
          <p class="nospace btmspace-30"> Ten a mano las noticias mas actuales del ampliop mundo de la ciberseguridad</p>
